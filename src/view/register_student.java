...
public class register_student extends JFrame {
    ...
    public register_student() {
        ...
        phone.setBounds(1078, 464, 228, 50);
        contentPane.add(phone);
        phone.setColumns(10);

        passwordField = new JPasswordField();
        passwordField.setFont(new Font("Tahoma", Font.PLAIN, 32));
        passwordField.setBounds(473, 464, 228, 50);
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String query = "INSERT INTO students values('" + ID + "','" +' '+ "','" +' '+ "','" +' '+ "','" +' '+ "','" +' '+ "','" + userName + "','" +
        ...
        btnNewButton.setBounds(652, 624, 259, 74);
        ...
        backto.setBounds(301, 605, 331, 57);
        ...
        image_blue.setIcon(new ImageIcon("D:\\zalo\\sevencolor.jpg"));
        image_blue.setBounds(137, 0, 1393, 94);
        contentPane.add(image_blue);
        
        JLabel jl_cmnm = new JLabel("New label");
        jl_cmnm.setIcon(new ImageIcon("D:\\zalo\\canhdep.jpg"));
        ...
        lblNewLabel_2.setIcon(new ImageIcon("D:\\zalo\\canhdep.jpg"));
